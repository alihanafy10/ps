...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gaming-darker p-4 md:p-8">
      {showWarning && (
        <div className="max-w-6xl mx-auto mb-4 bg-yellow-500/20 border border-yellow-500/50 text-yellow-200 p-4 rounded-xl flex flex-col sm:flex-row gap-3 justify-between items-start sm:items-center shadow-[0_0_15px_rgba(234,179,8,0.2)]">
          <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-4 py-2 w-full sm:w-auto text-center bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400 transition-colors text-sm"
          >
            Renew Now
          </a>
        </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6 md:mb-8 border-b border-gray-800 pb-4 justify-between items-start md:items-center">
          <div className="flex flex-wrap gap-2 md:gap-4 w-full md:w-auto">
            ...
            >
              <MonitorPlay className="w-4 h-4 md:w-5 md:h-5" /> Devices
            </button>
            <button
            ...
            >
              <Package className="w-4 h-4 md:w-5 md:h-5" /> Inventory
            </button>
            <button
            ...
            >
              <Users className="w-4 h-4 md:w-5 md:h-5" /> Staff
            </button>
            <button
            ...
            >
              <BarChart3 className="w-4 h-4 md:w-5 md:h-5" /> Reports
            </button>
          </div>

          <button
            onClick={() => setIsPosModalOpen(true)}
            className="flex items-center justify-center w-full md:w-auto gap-2 px-6 py-3 bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-lg shadow-[0_0_15px_rgba(168,85,247,0.4)] transition-colors"
          >
